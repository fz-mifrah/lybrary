...
describe('Publisher e2e test', () => {
  ...
  const publisherSample = { name: 'brand Botswana' };
  ...
  describe('Publisher page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Publisher page', () => {
  ...
  describe('new Publisher page', () => {
    ...
    it('should create an instance of Publisher', () => {
      cy.get(`[data-cy="name"]`).type('Assistant').should('have.value', 'Assistant');
